...
| Microservices implementation (MVP) | This project aims to deploy a demo microservice system | Java, Spring, Kubernetes, EC2, EKS, Jenkins | [auth](https://github.com/EmmaNguyen0410/auth-service) |
